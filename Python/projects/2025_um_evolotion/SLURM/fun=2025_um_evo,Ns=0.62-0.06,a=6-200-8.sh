...
#SBATCH -o /home/klimak/Codes/QuantumEigenSolver/Python/projects/2025_um_evolotion/SLURM/out-%j-fun=2025_um_evo,Ns=0.62-0.06,a=6-200-8.out
#SBATCH -e /home/klimak/Codes/QuantumEigenSolver/Python/projects/2025_um_evolotion/SLURM/err-%j-fun=2025_um_evo,Ns=0.62-0.06,a=6-200-8.err
#SBATCH --job-name=fun=2025_um_evo,Ns=0.62-0.06,a=6-200-8
...
python3 /home/klimak/Codes/QuantumEigenSolver/Python/projects/2025_um_evolotion/evolution.py     \
    ...
    10 0.62 0.06  \
    1 100000 1      \
    > /home/klimak/Codes/QuantumEigenSolver/Python/projects/2025_um_evolotion/LOG/RANDOM_MODELS_EVO_2025_UM/log_fun=2025_um_evo,Ns=0.62-0.06,a=6-200-8.log 2>&1
