...
main() {
    ...
    echo "# Debug: Print all arguments being passed"
    echo "echo 'Arguments passed to evolution.py:'"
    ...
    # Create SLURM job script
    {
        ...
        add_module_section "Python/3.10.8-GCCcore-12.2.0"
