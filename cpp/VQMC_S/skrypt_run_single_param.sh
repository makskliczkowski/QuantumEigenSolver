...
echo >> ${a}
echo "./vqmc.o -fun 21 -mod 4 -bc ${BC} -l 0 -d 1 -lx ${L} -ly 1 -J 1 -J2 ${J2} -h ${h} -g ${g} -eta ${eta} -eta2 ${eta} -dlt ${delta} -dlt2 ${delta} -w 0 -S 0 -su2 ${lhalf} -th 24 -dir Data/resultsXYZ${L}/ >& ./all_xyz/log_${a}.txt" >> ${a}
echo "      ${a}"
sbatch ${a}
rm ${a}