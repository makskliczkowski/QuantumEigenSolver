...
namespace NQS_NS
{
	...
	*/
	...
	{
		// **********************************************************************************************************************
		static_assert(NQS_S_concept<_spinModes, _Ht, _type, _stateType, _CorrState>, "NQS_PP: The NQS_S concept is not satisfied!");
		// **********************************************************************************************************************
		...
		using NQS_ref_t 			= 								NQS_ref<_spinModes, _Ht, _type, _stateType, _CorrState>;
		using NQS_ref_t_p			= 								typename std::shared_ptr<NQS_ref_t>;
		using NQS_pp_t				= 								NQS_PP<_spinModes, _Ht, _type, _stateType, _CorrState>;
		using NQS_pp_t_p			= 								typename std::shared_ptr<NQS_pp_t>;
		// **********************************************************************************************************************
	protected:
	...
	protected:														// -------------------- P R O B A B I L I T Y --------------------
		...
		auto logPRatio(Config_cr_t _v1)								-> _type override final { return this->logPRatio(NQS_STATE, _v1);};
	...
	public: 				  
		...
		NQS_PP(const NQS_pp_t& _other);
		NQS_PP(NQS_pp_t&& _other);
		// **********************************************************************************************************************
	public:															// --------------------- S E T T E R S ---------------------
